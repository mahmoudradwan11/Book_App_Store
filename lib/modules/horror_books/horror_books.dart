...
class HorrorBooks extends StatelessWidget {
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: const Text('Horror Books'),
            centerTitle: true,
          ),
          body: ListView.separated(
            itemBuilder: (context, index) =>
                builtHorrorItem(cubit.horrorBooks[index], context),
            separatorBuilder: (context, index) => builtDivider(),
            itemCount: cubit.horrorBooks.length,
          ),
        );
      },
    );
  ...
  Widget builtHorrorItem(HorrorModel model, context) => InkWell(
    onTap: (){
