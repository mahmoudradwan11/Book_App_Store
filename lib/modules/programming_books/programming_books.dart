...
class ProgrammingBooks extends StatelessWidget {
  const ProgrammingBooks({Key? key}) : super(key: key);
  @override
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: const Text('Programming Books'),
            centerTitle: true,
          ),
          body: ListView.separated(
            itemBuilder: (context, index) =>
                builtProgrammingItem(cubit.programmingBooks[index], context),
  ...
  Widget builtProgrammingItem(ProgrammingModel model, context) => InkWell(
    onTap: (){
